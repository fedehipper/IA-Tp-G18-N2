...
public abstract class Individuo implements Comparable<Individuo>, Cloneable {
    ...
    /**
     * TODO documentar que si nadie me define el random tomo varias desiciones
     * para generar los atributos: - Strings alfa-numerico de 10 caracteres -
    ...
    public int compareTo(Individuo otroIndividuo) {
        if (this.esMasAptoQue(otroIndividuo)) {
            return -1;
        } else if (otroIndividuo.esMasAptoQue(this)) {
            return 1;
        } else {
            return 0;
        }
    ...
    /**
     * En muchos casos, la mutación depende del problema ya que podrían
     * generarse individuos inválidos. Por esta razón, existe la posibilidad de
     * redefinir la mutación en el individuo. Este método realiza la mutación de
     * un atriburo aleatorio del individuo. Por cuestiones prácticas de
     * implementación, la mutación consiste en copiar un atributo desde
     * individuo de atributos aleatorios en lugar de mutar un bit como lo
     * especifica la teoría.
     *
     */
    public void mutar() {
